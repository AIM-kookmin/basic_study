...
def schedule(week):
    rows=([(5,'함께 볼 질문'),(10,'물체를 알아보는 단서'),(15,'지역성과 시각 연구'),(20,'필터·반응 지도·요약'),(15,'표현의 조합과 학습'),(15,'종이 위의 합성곱 활동'),(10,'개념 연결과 출구 질문')] if week==1 else [(5,'지난주 구조 복원'),(15,'단서·지름길·데이터'),(15,'증강과 이동의 차이'),(15,'깊이·잔차·규제'),(15,'평가와 근거 확인'),(15,'데이터·시험지 설계 활동'),(10,'해설과 종합')])
