...
from paper_components import render as render_paper
import re
...
def main():
    ...
    html=html.replace('<link rel="stylesheet" href="styles.css">','<link rel="stylesheet" href="styles.css"><link rel="stylesheet" href="paper.css">')
    html=html.replace('02 배우는 법','02 AlexNet 리딩').replace('56페이지','68페이지')
